...
export default function CreateOrphanage() {
  ...
  function handleSelectImages(event: ChangeEvent<HTMLInputElement>) {
    ...
    const selesctedImages = Array.from(event.target.files);

    setImages(selesctedImages);

    const selesctedImagesPreview = selesctedImages.map((image) => {
      return URL.createObjectURL(image);
    });

    setPreviewImages(selesctedImagesPreview);
  }
